...
def make_slonim(oct,division,stuff_n,start_note,polation):
    ...
    for el in comb:
        ...
        for i in range(0,division):
            ...
            for offset in el:
                # TODO: MORE COMPLICATED THAN SIMPLE SUBTRACT!
                # Figure out how to compute easily/simply
                nt = {
...
if __name__ == "__main__":
    ...
    polation = argvs[5] if len(argvs) == 6 else 'interpolation'

    if((oct * 12) % division):
        print ("Error: octave % division != 0")
        quit()

    make_slonim(oct,division,stuff_n,start_note,polation)
